...
.header {
  ...
  .wishlist .upload-aso, .image-button .upload-aso {
    display: flex;
    width: 25%;
    border-radius: 4px;
    padding: 16px 20px;
  ...
  .wishlist .upload-aso .success-image ,.image-button .upload-aso .success-image {
    display: flex;
   gap:10px;
   align-items:center ;
  ...
  @media screen and (max-width: 1024px) {
    ...
    .wishlist .upload-aso label,  .image-button .upload-aso label {
      font-size: 12px;
    }
    .bank .in-border {
    display: flex;
